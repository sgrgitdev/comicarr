...
_CONFIG_DEFINITIONS = OrderedDict(
    {
        ...
        "KAVITA_SCAN_ENABLED": (bool, "Kavita", False),
        "KAVITA_HOST": (str, "Kavita", None),
        "KAVITA_USERNAME": (str, "Kavita", None),
        "KAVITA_PASSWORD": (str, "Kavita", None),
        "KAVITA_LIBRARY_ID": (int, "Kavita", 0),
        "KAVITA_LIBRARY_IDS": (str, "Kavita", None),
        "KAVITA_COMICS_LIBRARY_ID": (int, "Kavita", 0),
        "KAVITA_MANGA_LIBRARY_ID": (int, "Kavita", 0),
        "KAVITA_SCAN_MIN_INTERVAL": (int, "Kavita", 60),
